...
export interface AgentExecutionGrantInput { collaborationId: string; assignmentId: string; worktreeLeaseId?: string; cwd: string; environment?: Record<string, string> }
